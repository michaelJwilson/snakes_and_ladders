...
`oxi_snakes_and_ladders`, replacing `snakes_and_ladders` and `oxi_snakes_and_ladders`. The old names
referred to phylogenetics, one of the three problem classes this project
supports on equal footing. The console script `run_snakes_and_ladders` becomes
