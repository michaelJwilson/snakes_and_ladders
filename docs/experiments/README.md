...
| [024](024-what-a-draw-costs-in-gradients.md) | mixture | stress | hmc, mala, slice | 0 | confirmed | **No: the trajectory is not paid for at these dimensions, and neither unit decides it alone.** MALA takes 1.7x to 2.6x HMC's effective samples per gradient o... |
