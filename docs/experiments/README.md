...
| [7](007-batched-rollout-and-torchrl-ppo.md) | potts-lattice | ci | sequential, gymnasium-vector, torchrl | 1920 | confirmed | `SyncVectorEnv` costs 1.18x to 1.75x per episode against the sequential rollout at every batch size measured, on every fixture, and the cost does not fall wi... |
