...
| [7](007-per-fit-cost-of-the-tree-likelihood.md) | tree | release | eager, torch-compile, rust-binding | 0 | confirmed | `torch.compile` does not close the gap and PR 2 and PR 3 are not refused by it: the compiled recursion is **1.21x and 1.09x slower** than eager at 8 and 20 t... |
