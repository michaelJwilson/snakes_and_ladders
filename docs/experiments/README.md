...
| [4](004-tree-policy-features.md) | tree | release | greedy, reinforce-improvement, reinforce-full | 640 | confirmed | With the single feature the trained policy ties greedy (0.487 against 0.480, p = 0.79), as #178 measured. With the full set it reaches the maximum from 0.796... |
