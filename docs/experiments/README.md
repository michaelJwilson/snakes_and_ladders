...
| [009](009-gaussian-mixture-seeding-control.md) | mixture | release | random-restart, kmeans++, emission-d2, burn-in, family-sample, spectral, hmc, tempering, anneal | 40 | confirmed | **It ties in the divergence and loses in the implementation**: the negative log density is the divergence plus the log normalizer, D-squared sampling normali... |
