...
| [009](009-gaussian-mixture-seeding-control.md) | mixture | release | random-restart, kmeans++, emission-d2, burn-in, family-sample, spectral, hmc, tempering, anneal | 40 | confirmed | **The divergence ties and the implementation loses**, on both rungs and by 1.6x at the larger: the negative log density is the divergence plus the log normal... |
