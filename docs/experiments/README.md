...
| [8](008-frameworks-on-three-hot-paths.md) | potts-lattice | stress | ours, scipy-csgraph, rustworkx, torch-geometric | 0 | confirmed | All three declined; the 1.52x-1.98x that landed instead is this repository's own pointer doubling and sorted grouping, and each front is conserved in `sandbo... |
