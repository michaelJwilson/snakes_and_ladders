...
| [7](007-pruning-gradient-routes.md) | tree | ci | taped, burn, analytic | 60 | confirmed | **The prediction held.** `burn`'s tape is 66, 134 and 270 nodes at 4, 8 and 16 taxa against PyTorch's 59, 115 and 227 --- linear in the tree either way, and... |
