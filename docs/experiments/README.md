...
| [20](020-potts-gradient-proposals.md) | potts-lattice | stress | single-site, locally-balanced, gibbs-with-gradients | 0 | confirmed | Yes in sweeps, no in work: 4.96 sweeps buy an independent sample against the heat bath's 10.50, **2.1x fewer**, at **8.1x** the wall per sweep in NumPy and 2... |
