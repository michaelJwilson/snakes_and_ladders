...
| [008](008-frameworks-on-three-hot-paths.md) | potts-lattice | stress | ours, scipy-csgraph, rustworkx, torch-geometric | 0 | confirmed | **No framework is adopted.** #390 fails the profile bar outright: the `index_add` the framework would front is 7.0% of the fit, under #341's 10%, and PyG is... |
