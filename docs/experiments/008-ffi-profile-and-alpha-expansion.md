...
| `sample.gibbs.sample_factor_graph` 32x32: `conditional` 44.8% | 44.8% | not here: #341's, carried by [#561](https://github.com/michaelJwilson/snakes_and_ladders/issues/561) |
