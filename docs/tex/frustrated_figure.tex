...
\begin{tikzpicture}[
    scale=1.05,
    spin/.style={circle, draw, minimum size=0.44cm, inner sep=0pt, font=\tiny, fill=white},
    up/.style={circle, draw, fill=black!10, minimum size=0.44cm, inner sep=0pt, font=\tiny},
    down/.style={circle, draw, fill=black!45, text=white, minimum size=0.44cm, inner sep=0pt, font=\tiny},
