...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccccccccccc}
    ...
    \midrule
    Phylogenetic tree, Jukes--Cantor & $\checkmark$ & $\checkmark$ & -- & $\checkmark$ & -- & -- & $\checkmark$ & $\checkmark$ & -- & -- & -- & $\checkmark$ \\
    Phylogenetic tree, general time-reversible & $\checkmark$ & $\checkmark$ & -- & $\checkmark$ & -- & -- & $\checkmark$ & -- & -- & -- & -- & -- \\
