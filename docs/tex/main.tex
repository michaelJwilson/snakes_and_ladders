...
\begin{figure}[htbp]
  ...
  \caption{Wall-clock convergence of the \texttt{snakes\_and\_ladders} framework against IQ-TREE 2 and RAxML-NG on empirical benchmark datasets.}
