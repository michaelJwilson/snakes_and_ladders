...
factors, and no fourth code path. Its three terms are the three problem
...
ceilings apply to it unchanged.
...
\paragraph{What is deliberately not attempted.}
The quantum code Equation~\ref{eq:bicycle-css} opens. A pair of matrices
satisfying it defines a Calderbank--Shor--Steane code, whose decoding problem
is syndrome decoding with \emph{degeneracy}: distinct errors sharing a
syndrome can act identically on the codespace, so the criterion refereeing
every decode in this section --- agreement with the maximum-likelihood
codeword --- is the wrong question there, and what replaces it has to be
written down before any decoding claim is made. Non-binary codes, since a
