...
rather than to a per-draw agreement---the rule \texttt{sim/CLAUDE.md}
states for every asymptotic result.
...
\citet{blahut2003}, \citet{gallager1962}, \citet{richardson2008}, with
\citet{nielsen2010} as background only.
