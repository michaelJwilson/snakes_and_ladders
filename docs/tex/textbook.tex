...
A fifth kind is available and deliberately not used as a start: a tempered
ensemble estimates a \emph{distribution} rather than a point, so its cold
replica's weights, Equation~\ref{eq:tempered-weight}, are an answer and not a
starting point. Reading one as the other is the standing error about
Appendix~\ref{app:tempering}.
