...
\begin{table}[htbp]
  ...
  Sylvester--Hadamard matrix italic.}
  \label{tab:notation}
\end{table}
...
the continuous ones fitted. Its gradient is a posterior expectation,
\begin{equation}
...
\end{equation}
the sum over factors of the derivative of a factor's own log-potential
averaged under the belief at that factor (Appendix~\ref{app:logz}). Two things
