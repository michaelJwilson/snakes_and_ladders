...
is what makes list decoding competitive in practice; the check is polynomial
division over $\mathrm{GF}(2)$, which the elementary codes carry, and the
combination is the next step here.
