...
$\branch$ and $\Q$ are what the continuous optimization fits. The scaling
constants themselves are not: Appendix~\ref{app:pruning} shows that they
leave the site likelihood unchanged, so they carry no derivative with respect
to $\branch$ or $\Q$ and differentiating them computes a zero.
