...
\begin{table}[htbp]
  ...
  \begin{tabular}{ll}
    ...
    $\energy$      & a Hamiltonian: the energy of a configuration \\
    ...
    $\hadamard$    & the Sylvester--Hadamard matrix \\
    \addlinespace
...
factors, and no fourth code path. Section~\ref{sec:coupled} states the modelEquation~\ref{eq:factor-graph} with pairwise, chain and
degree-two gated factors, and no fourth code path. Its three terms are the
three problem classes above: a Potts prior on the labels,
\begin{equation}
