...
lattice to the chains (Figure~\ref{fig:coupled:sketch}). The graph has cycles, so Equation~\ref{eq:sum-product}
...
$d_v + 1$ (Figure~\ref{fig:ldpc:sketch}). The graph has cycles---a random draw of the ensemble does not
