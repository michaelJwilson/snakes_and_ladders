...
Figure~\ref{fig:rl-convergence} poses Milestone 2.1's phylogenetic comparison on a
...
worse than it. Its outcome bears on two items the roadmap schedules --- the
richer feature set of Milestone 2.1, and the accepted-worsening steps of
Stage 3's stochastic escape mechanisms --- because the limits it runs into are
the ones those items remove. The remaining figures are populated on completion
of the benchmarking milestone.
