...
No comparison against IQ-TREE~2 or RAxML-NG has been run: the tools are not
in the environment, and installing them is a ticket of its own (\#126). And
...
hidden Markov models, the parity-check code, the coupled model and the
mixture without encoding any of them. Every evaluator is pinned to
