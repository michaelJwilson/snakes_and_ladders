...
\begin{tikzpicture}[
    ...
    y={(0cm, 1.1cm)},
    z={(1.5cm, 0cm)},
    % The shared vocabulary of preamble.tex, at the diameters this lattice
    % leaves room for: the drawing is three-dimensional and dense, so the
    % circles and squares are smaller here than in the flat sketches.
    latent/.style={fgvariable, minimum size=0.50cm, font=\tiny},
    x_latent/.style={fgvariable, minimum size=0.18cm, inner sep=0pt},
    factor_style/.style={fgfactor, minimum size=0.10cm},
    high_factor_style/.style={fggate},
    edge_style/.style={fglink},
