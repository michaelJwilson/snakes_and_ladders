...
| [`docs/paper.pdf`](docs/paper.pdf), [`docs/textbook.pdf`](docs/textbook.pdf), `docs/mind_map.pdf` | The rendered documents, committed and regenerated by `infra/build_documents.sh` |
