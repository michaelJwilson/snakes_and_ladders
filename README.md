...
| [`docs/paper.pdf`](docs/paper.pdf), [`docs/textbook.pdf`](docs/textbook.pdf), `docs/mind_map.pdf` | The rendered documents, committed and regenerated by `infra/build_documents.sh`; `docs/textbook.pdf` is missing since f16a26ab's rebuild deleted it (#847) |
