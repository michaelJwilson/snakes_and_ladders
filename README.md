...
| [CHECKS.md](CHECKS.md) | The checks the claims rest on, generated from the tests |
| [SEAMS.md](SEAMS.md) | The protocols and shared contracts, their implementers and consumers, generated from the package |
