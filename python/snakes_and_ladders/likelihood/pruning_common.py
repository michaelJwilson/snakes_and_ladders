...
``snakes_and_ladders.likelihood.pruning`` imports nothing from here and never
...
def leaf_indicator(
    ...
    *,
    ...
    index_device : torch.device | None
        ...
        :func:`snakes_and_ladders.likelihood.pruning_torch.log_likelihood_cached`
...
def rescale_partial(
    ...
    fallback : torch.Tensor | None
        ...
        which is what :mod:`snakes_and_ladders.likelihood.pruning_analytic`
