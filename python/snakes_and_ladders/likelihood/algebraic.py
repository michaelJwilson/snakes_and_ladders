...
The codes are constructed in ``sim/`` --- :mod:`snakes_and_ladders.sim.reed_solomon`
and :mod:`snakes_and_ladders.sim.elementary_codes` --- and decoding them is
...
from snakes_and_ladders.sim.reed_solomon import ReedSolomon
