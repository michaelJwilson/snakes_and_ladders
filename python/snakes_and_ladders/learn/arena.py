...
:class:`~snakes_and_ladders.learn.policy.EpsilonGreedyPolicy`'s docstring
...
#: :func:`~snakes_and_ladders.learn.ppo.ppo`'s default, and declared rather
...
class Streams:
    ...
    policy : torch.Generator
        ...
        zero, which :class:`~snakes_and_ladders.learn.policy.LinearPolicy`
        does.
...
class Learner:
    ...
    train : Callable | None
        ...
        from :func:`~snakes_and_ladders.learn.rollout.greedy_rollout` instead.
