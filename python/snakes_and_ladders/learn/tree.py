...
:class:`snakes_and_ladders.learn.environment.Environment`, beside
:mod:`snakes_and_ladders.learn.potts`, :mod:`snakes_and_ladders.learn.potts_nd`
and :mod:`snakes_and_ladders.learn.hmm`, which are the same object for the
other problems (issue #779). With :mod:`snakes_and_ladders.learn.ranking` it is
