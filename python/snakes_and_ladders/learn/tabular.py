...
from snakes_and_ladders.learn.canonical import ValueFunction
...
class ActionValues[S, A]:
    ...
    def value(self, state: S) -> float:
        ...
        :func:`~snakes_and_ladders.learn.canonical.value_iteration` holds
    ...
    def greedy_actions(self, state: S) -> list[A]:
        ...
        :meth:`~snakes_and_ladders.learn.canonical.ValueFunction.optimal_actions`
    ...
    def largest_deviation(
        ...
        optimal : ValueFunction[S]
            From :func:`~snakes_and_ladders.learn.canonical.value_iteration`.
        at_least : int
...
def q_learning[S, A](
    ...
    *,
    ...
    :func:`~snakes_and_ladders.learn.canonical.value_iteration`'s directly.

    Undiscounted, matching the rest of :mod:`snakes_and_ladders.learn`: the
    rewards are improvements and the episodes terminate, so ``gamma = 1``
    needs no separate justification
    (:class:`~snakes_and_ladders.learn.environment.Episode`).
