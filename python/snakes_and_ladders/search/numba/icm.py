"""The ``numba`` descent sweep of :mod:`snakes_and_ladders.search.icm`, on the Rust sweeps' signature.
...
:func:`snakes_and_ladders.search.icm.iterated_conditional_modes` reads the
