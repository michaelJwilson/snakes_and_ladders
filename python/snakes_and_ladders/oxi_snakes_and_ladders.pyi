...
src/pruning_burn.rs, src/maxflow.rs, src/sampling.rs, src/coupled.rs and
src/count_pairs.rs. Issue #37 tracks putting `stubtest` in CI so the drift is
caught by a check rather than by whoever notices; until then,
