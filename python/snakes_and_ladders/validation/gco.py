...
:mod:`snakes_and_ladders.search.alpha_expansion`. Its terms are research-use,
...
of each under :func:`snakes_and_ladders.sim.potts.energy`, and the properties
...
class Expansion:
    ...
    #: The labelling's energy under :func:`snakes_and_ladders.sim.potts.energy`.
    energy: float
