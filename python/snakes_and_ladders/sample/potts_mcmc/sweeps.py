...
:mod:`~snakes_and_ladders.sample.potts_mcmc.chains`'. The route between the
Python oracle and the Rust sweep is chosen here, per kernel, by the backend
the caller names. Imports :mod:`~snakes_and_ladders.sample.potts_mcmc.moves`
alone.
"""
...
from snakes_and_ladders.sample.potts_mcmc.moves import PottsMove
