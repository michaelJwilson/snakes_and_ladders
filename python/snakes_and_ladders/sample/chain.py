...
:mod:`snakes_and_ladders.sample.hmc_jax` builds on a declared energy.

HMC (:mod:`snakes_and_ladders.sample.hmc`), MALA
(:mod:`snakes_and_ladders.sample.langevin`) and random-walk Metropolis
(:mod:`snakes_and_ladders.sample.metropolis`) each supply a kernel and share
