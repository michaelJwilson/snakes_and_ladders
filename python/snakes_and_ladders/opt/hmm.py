...
def baum_welch(
    ...
    backend : Backend
        ...
        ``oxi_snakes_and_ladders.categorical_em_step``: scaled messages
...
def _streamed_baum_welch(
    ...
    *,
    ...
    def step(
        ...
        initial, transition, emission, log_likelihood = (
            oxi_snakes_and_ladders.categorical_em_step(symbols, *state)
        )
