...
:mod:`~snakes_and_ladders.opt.hmm.forward` holds the kernels --- the forward
recursion and the state alignment --- that the other two share;
:mod:`~snakes_and_ladders.opt.hmm.objectives` the gradient-fit objectives, one
per emission family; and :mod:`~snakes_and_ladders.opt.hmm.estimation` the EM
...
``from snakes_and_ladders.opt.hmm import X`` is unchanged.
...
share, which :mod:`snakes_and_ladders.opt.hmm_jax` reads from here until issue
...
from snakes_and_ladders.opt.hmm.estimation import (
    CategoricalFit,
    CovariateUpdate,
    EmFit,
...
from snakes_and_ladders.opt.hmm.forward import (
    align_by_key,
    align_families,
    align_states,
...
from snakes_and_ladders.opt.hmm.objectives import (
