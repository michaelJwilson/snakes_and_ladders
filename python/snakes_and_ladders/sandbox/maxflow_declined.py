...
behind :mod:`snakes_and_ladders.search.maxflow_rust`'s seam --- Dinic (the
...
Only ``tests/`` and :mod:`snakes_and_ladders.qa` import from here.
"""
...
def ising_ground_state(
    ...
    :func:`snakes_and_ladders.search.maxflow_rust.ising_ground_state`: the
