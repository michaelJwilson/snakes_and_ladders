...
#: figures --- every one of them since issue #490 removed the stamps ---
#: and one figure over this cap is a third of the 300 s budget `DEV.md`
#: gives the whole validation (issue #372). A figure that cannot fit
