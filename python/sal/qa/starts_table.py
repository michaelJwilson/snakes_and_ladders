...
:class:`~sal.search.mixture_starts.StartRow` rows the starts
notebook reads, in the ``tabular`` shape
:func:`sal.qa.figure.write_qa_table` writes, so a document can
...
def build_table(
    ...
    tuple[str, str]
        ...
        :func:`~sal.qa.figure.check_latex_safe` accepts.
    """
