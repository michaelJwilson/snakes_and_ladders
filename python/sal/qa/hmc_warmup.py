...
The warm-up of ``sal.sample.hmc.Adaptation`` discards every draw
...
Renders what `sal.sample.hmc` sampled; it reimplements no sampler
(`qa/CLAUDE.md`).
"""
...
from sal.qa.runner import figure_main
