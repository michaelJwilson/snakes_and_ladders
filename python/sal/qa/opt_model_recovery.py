...
general time-reversible model (:mod:`sal.sim.gtr`), and the figure makes
...
Renders what `sal.likelihood` and `sal.opt` computed; it reimplements no
...
from sal.likelihood.objective import SubstitutionModelObjective
