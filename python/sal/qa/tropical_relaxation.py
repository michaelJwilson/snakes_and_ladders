...
Renders what ``sal.sandbox.tropical`` and
``sal.search.infer`` computed; it reimplements no score
...
from sal.qa.style import INK_MUTED, ONE_COLUMN_WIDE, letter_style
