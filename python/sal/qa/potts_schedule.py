...
**The search.** Per move and per :class:`~sal.sample.schedule.ScheduleShape`,
...
Run as ``uv run --no-sync python -m sal.qa.potts_schedule``.
"""
...
from sal.sim.fixtures import REPO_ROOT, fixture
