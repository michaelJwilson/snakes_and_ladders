...
Two consumers read this. Per pull request, ``sal.qa.build``
...
FIGURES: tuple[FigureSpec, ...] = (
    ...
    FigureSpec(
        "backend_agreement",
        "sal.qa.backend_agreement",
        ("--params", f"{FIXTURES}/tree_jc/stress.yaml"),
        seconds=3.1,
    ),
    FigureSpec(
        "likelihood_footprint",
        "sal.qa.likelihood_footprint",
        ("--params", f"{FIXTURES}/tree_jc/ci.yaml"),
        seconds=2.6,
    ),
    FigureSpec(
        "sim_problem_sizes",
        "sal.qa.sim_problem_sizes",
        (
            "--params",
    ...
    FigureSpec(
        "tropical_relaxation",
        "sal.qa.tropical_relaxation",
        ("--params", f"{FIXTURES}/tree_search/ci.yaml"),
        seconds=5.4,
    ),
    FigureSpec(
        "parsimony_zones",
        "sal.qa.parsimony_zones",
        ("--params", f"{FIXTURES}/tree_jc/release.yaml"),
        seconds=4.6,
    ),
    FigureSpec(
        "frustrated_lattices",
        "sal.qa.frustrated_lattices",
        ("--params", f"{FIXTURES}/frustrated_lattice/ci.yaml"),
        seconds=3.9,
    ),
    FigureSpec(
        "mixture_seeding",
        "sal.qa.mixture_seeding",
        ("--params", f"{FIXTURES}/mixture/ci.yaml"),
        seconds=27.4,
    ),
    FigureSpec(
        "optimizer_landscapes",
        "sal.qa.optimizer_landscapes",
    ...
    FigureSpec(
        "turbo_waterfall",
        "sal.qa.turbo_waterfall",
        ("--params", f"{FIXTURES}/turbo/stress.yaml"),
        seconds=16.0,
    ),
    FigureSpec(
        "coupled_labelling",
        "sal.qa.coupled_labelling",
