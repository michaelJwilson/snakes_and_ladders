...
Renders what `sal.search` and `sal.likelihood` computed; it reimplements
...
from sal.qa.figure import QAFigure, latex_integer
from sal.qa.runner import FIXTURE_PARAMS, figure_main
from sal.qa.sim_tree import render_sim_tree
from sal.qa.style import ONE_COLUMN_WIDE, letter_style
