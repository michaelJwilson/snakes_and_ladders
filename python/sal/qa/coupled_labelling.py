...
Renders what `sal.sim.spatio_sequential` drew and what
`sal.search.spatio_sequential` fitted; it runs no annealing
...
from sal.qa.layout import discrete_legend
...
def best_permutation(
    ...
    :func:`~sal.search.spatio_sequential.label_accuracy`'s,
