...
class ParityCheck:
    ...
    def from_edges(
        ...
        # structure, `sal.incidence.SparseIncidence`, which
...
def gf2_rank(matrix: np.ndarray) -> int:
    ...
    how :meth:`sal.sim.css.CssCode.is_stabilizer` decides it.
...
def null_space(matrix: np.ndarray) -> np.ndarray:
    ...
    and :func:`sal.sim.convolutional.parity_check` takes the
