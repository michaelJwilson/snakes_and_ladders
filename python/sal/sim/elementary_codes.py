...
second part and live in :mod:`sal.sim.reed_solomon` and
:mod:`sal.sim.galois`. What is **not** here is BCH, which that
machinery makes cheap afterwards and which nothing yet asks for. Nor is a codeword
enumerator: :func:`sal.likelihood.ldpc.enumerate_codewords`
...
def golay_code(*, extended: bool = False) -> ParityCheck:
    ...
    **The shifts of the generator polynomial are the generator matrix, not the
    ...
    :func:`sal.sim.ldpc.null_space`, the one home of the GF(2)
