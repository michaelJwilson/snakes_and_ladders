...
:mod:`sal.likelihood.convolutional` may terminate both ends.
...
from sal.sim.ldpc import ParityCheck, null_space
...
#: :mod:`sal.likelihood.convolutional`, so it is stated once.
...
#: decoders of :mod:`sal.likelihood.convolutional` are linear
...
def parity_check(code: TurboCode) -> ParityCheck:
    ...
    is a :class:`~sal.sim.ldpc.ParityCheck` and issue #340's
    ...
    taking :func:`sal.sim.ldpc.null_space` of that -- the same
