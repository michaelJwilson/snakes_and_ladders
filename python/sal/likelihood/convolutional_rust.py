"""Rust log-MAP BCJR (``sal.oxisal.bcjr_forward_backward``),
pinned against :func:`sal.likelihood.convolutional.bcjr`, the
...
:class:`~sal.sim.convolutional.Trellis` already holds
...
from sal.likelihood.convolutional import TrellisDecoding
from sal.sim.convolutional import Trellis
...
def bcjr(
    ...
    *,
    ...
    :func:`sal.likelihood.convolutional.bcjr`'s arguments and
