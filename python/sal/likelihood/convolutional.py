...
:func:`sal.sim.factor_graph.from_trellis` presents the same
chain to the general
:func:`sal.likelihood.message_passing.sum_product`, whose tree
...
def bcjr(
    ...
    *,
    ...
    with :func:`sal.numerics.logsumexp`, so nothing here is an
    ...
    backend : Backend
        ...
        :func:`sal.likelihood.rust.convolutional.bcjr` and
