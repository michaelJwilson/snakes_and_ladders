...
The recursion is :func:`sal.likelihood.pruning_torch.log_likelihood`'s
...
The objectives in :mod:`sal.likelihood.objective` map their
...
from sal.likelihood.pruning_torch import traversal
