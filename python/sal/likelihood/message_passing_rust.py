"""Rust tree schedule (``sal.oxisal.tree_message_passing``),
pinned against :func:`sal.likelihood.message_passing.sum_product`
...
:mod:`sal.likelihood.message_passing_reference`.
...
:class:`~sal.likelihood.schedule.Layout` holds its incidences as
...
def tree_messages(layout: Layout, *, maximum: bool) -> TreeMessages:
    ...
    :attr:`~sal.likelihood.schedule.Layout.root` as the Python
    ...
    TreeMessages
        ...
        :func:`sal.likelihood.message_passing._run` carries
