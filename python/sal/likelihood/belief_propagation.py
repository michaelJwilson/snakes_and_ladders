...
:func:`sal.likelihood.potts.enumerate_potts` is the right
assertion; the loopy case is *reported* against
:func:`sal.likelihood.potts.strip_log_partition` as a measured
...
def belief_propagation(
    ...
    *,
    ...
    field : np.ndarray
        ...
        ``exp(h)``, matching :func:`sal.likelihood.potts.log_weights`.
    damping : float
