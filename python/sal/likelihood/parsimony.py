...
the search machinery (:func:`sal.search.infer.parsimony_search`),
...
def sankoff_score(
    ...
    (:func:`sal.search.infer.parsimony_search`).
...
def brute_force_parsimony_score(
    ...
    :func:`sal.likelihood.brute_force.brute_force_log_likelihood`
    ...
    from sal.sim.tree import edges, preorder
