...
from sal.likelihood.convolutional import bcjr, enumerate_messages
from sal.likelihood.ldpc import Decoding, MapEstimate
...
from sal.sim.ldpc import LLR_CAP
...
def decode_turbo(
    ...
    *,
    ...
    backend : Backend
        ...
        :func:`~sal.likelihood.convolutional.bcjr` and
        carrying its default. Issue #754 moved that default to
        :data:`~sal.backend.Backend.RUST`, which is 26.2x
    ...
    Decoding
        ...
        ``estimate`` is :attr:`~sal.likelihood.ldpc.MapEstimate.BITWISE`,
