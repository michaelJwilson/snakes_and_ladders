...
``sal.learn.surrogate`` sees tensors; this module, which imports the
...
from sal.learn.surrogate import CalibratedBound, Examples, Fitted
...
from sal.sim.potts import SpatioOnlyParams, spatio_only_field
from sal.sim.topology import Model, Topology
...
def ground_state_target(
    ...
    :func:`~sal.likelihood.surrogate.decoupled_ground_energy`
    below it.
