...
:data:`~sal.opt.budget.Method`, a family of instances indexed by
...
:func:`sal.opt.budget.restarts` derives the restart count from
...
from sal.opt.budget import Budget, Method, OverspendError
...
def probe_failure(
    ...
    *,
    ...
    method : Method
        ...
        :func:`~sal.opt.budget.restarts` of a single descent,
