...
class Policy(Protocol):
    """What :func:`sal.learn.rollout.rollout` needs of a policy.
    ...
    :func:`sal.learn.reinforce.reinforce` needs the weights and the
...
class LinearPolicy(TrainablePolicy):
    ...
    dtype : torch.dtype
        ...
        oracle in :mod:`sal.learn.exact` compares against finite
    ...
    def log_probabilities(self, features: FeatureRows) -> torch.Tensor:
        ...
        features : FeatureRows
            ...
            :meth:`sal.learn.environment.Environment.features` returns.
