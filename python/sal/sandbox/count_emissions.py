...
Conserved, not replaced. :class:`~sal.emissions.NegativeBinomialEmission`
and :class:`~sal.emissions.BetaBinomialEmission` gain a
...
Only :class:`~sal.emissions.Reestimate` is imported rather than
...
from sal.emissions import Reestimate
