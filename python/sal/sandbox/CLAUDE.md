...
| `surrogate.potts` | declined | ground-state labelling on `spatio_tiling`, read as the gap to the TRW-S bound against ICM, alpha-expansion and Swendsen--Wang on held-out draws; relabelling the states permutes its logits bitwise (#1067) |
