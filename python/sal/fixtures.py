...
The module names no model, so `sal.opt` may import it without acquiring an
application reference, on the same terms as :mod:`sal.numerics` and
:mod:`sal.enumeration`.
