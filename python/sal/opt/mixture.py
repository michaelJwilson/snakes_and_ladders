...
components *is*
:meth:`sal.emissions.GaussianEmission.reestimate`, called with
...
:mod:`sal.opt.initialize` for the reason #251 gave: a strategy
...
class GaussianMixtureObjective(Objective):
    ...
    observations : np.ndarray
        ...
        :class:`sal.emissions.GaussianEmission` states.
    n_components : int
...
def mixture_log_likelihood(
    ...
    *,
    ...
    components : EmissionFamily
        ...
        :mod:`sal.opt.emission_mixture` fit a mixture of count
    ...
    backend : Backend
        ...
        :class:`~sal.emissions.GaussianEmission` over a
        ...
        :data:`~sal.backend.Backend.PYTHON`, take torch, which
...
class MixtureMetrics:
    ...
    **The assignment agreement the ticket listed is left out.** The only
    ...
    :func:`sal.likelihood.mixture_assignments.enumerate_mixture_assignments`,
...
class MixtureFit:
    ...
    at_boundary : bool
        ...
        error (issue #122), as
        :attr:`sal.opt.emission_mixture.EmissionMixtureFit.at_boundary`
...
def expectation_maximization(
    ...
    :func:`sal.opt.em.em_loop`'s (issue #859); this entry
    ...
    backend : Backend
        ...
        :data:`~sal.backend.Backend.PYTHON` is that route, and
...
class KMeansPlusPlus(Initializer):
    ...
    :class:`sal.opt.initialize.Initializer` unchanged and
