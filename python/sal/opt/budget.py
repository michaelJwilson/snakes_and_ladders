...
:class:`sal.cost.Cost`: a sweep and a likelihood evaluation
...
class Budget:
    ...
    unit : Cost
        ...
        (:class:`sal.cost.Cost`, issue #860): a comparison
...
def compare(
    ...
    *,
    ...
    workers : int
        Cells run at once, through :func:`sal.parallel.map_tasks` on
