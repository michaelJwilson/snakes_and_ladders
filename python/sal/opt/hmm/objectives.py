...
class _HmmObjective(Objective):
    ...
    def observations(self) -> torch.Tensor:
        ...
        (:func:`sal.opt.starts.polish_by_baum_welch`, issue
        #894).
        """
    ...
    def jax_energy(self) -> tuple[Callable[[Any, Any], Any], dict[str, Any]] | None:
        ...
        (:class:`~sal.sample.declared.DeclaredJaxEnergy`).
        """
        if self._backend is not Backend.JAX:
            return None
        from sal.opt.hmm.jax import jax_energy
    ...
    def value_and_gradient(
        ...
        the compiled twin of :mod:`sal.opt.hmm.jax` takes both
...
class NegativeBinomialHmmObjective(_HmmObjective):
    ...
    **The identifiability hazard is flatness.** Both parameters reach the
    ...
    :func:`sal.emissions.identifiable_dispersion_bound` says
