"""Standard continuous test functions, as :class:`~sal.opt.objective.Objective`.

Every other test of :func:`sal.opt.fit.fit` measures a
...
:func:`sal.opt.fit.constrained_standard_errors` must not be
