...
:func:`~sal.opt.hmm.align_by_key` returns: component ``k`` of
...
first two from any :class:`~sal.emissions.EmissionFamily`
...
:class:`~sal.sample.chain.Chain`'s draws --- is accepted and
...
:class:`~sal.emissions.EmissionFamily` it is handed, whose
