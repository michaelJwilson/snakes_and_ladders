...
number :func:`~sal.sample.hmc.sample` accepts on. This module
...
#: :class:`~sal.sample.hmc.Adaptation`, whose every field is
#: required.
...
def mala(
    ...
    *,
    ...
    adaptation : Adaptation | None
        ...
        :func:`~sal.sample.hmc.sample` runs. Its
    ...
    backend : Backend
        ...
        Any other chain, and
        :data:`~sal.backend.Backend.PYTHON`, take the torch
        kernel.
