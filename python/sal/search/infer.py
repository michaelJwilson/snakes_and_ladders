...
So nothing here needed to change `sal.opt`: the same ``fit``
...
the same neighbourhoods with :func:`~sal.likelihood.parsimony.fitch_score`
or :func:`~sal.likelihood.parsimony.sankoff_score` in place of
...
def infer(
    ...
    *,
    ...
    radius : int | None
        ...
        (:func:`~sal.sim.topology.spr_neighbours`), making the
...
def parsimony_search(
    ...
    *,
    ...
    :func:`~sal.sim.topology.enumerate_topologies` referees
    ...
    step_matrix : np.ndarray | None
        ...
        :func:`~sal.likelihood.parsimony.sankoff_score` and must
