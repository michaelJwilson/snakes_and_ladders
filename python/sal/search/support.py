...
* **tempered support**: the fraction of a tempered ensemble's
  ...
  (:mod:`sal.sample.tempered`; ``docs/tex/textbook.tex``,
...
weight :func:`sal.likelihood.potts.enumerate_potts` normalizes
at ``beta = 1`` and the path posterior
:func:`sal.likelihood.hmm_paths.enumerate_hidden_paths` sums,
...
from sal.sample.tempered import TemperedEnsemble
...
def enumerated_labelling_support(
    ...
    *,
    ...
    labellings, on :func:`sal.enumeration.refuse_oversized`'s
    terms.
...
def tempered_labelling_support(
    ...
    :func:`sal.sample.tempered.tempered_factor_graph` on
...
def tempered_topology_support(
    ...
    *,
    ...
    ``ensemble`` is a run of
    :func:`sal.sample.tempered.tempered_topologies` on
...
def bootstrap_support(
    ...
    *,
    ...
    replicate order (:func:`sal.parallel.map_tasks`), resamples
