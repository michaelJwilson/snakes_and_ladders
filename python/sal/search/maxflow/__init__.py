...
class FlowNetwork:
    ...
    **Why ``outgoing`` is a list of lists.** Root ``CLAUDE.md`` asks for
    ...
    :mod:`sal.search.maxflow.rust`, and that is the boundary
    ...
    counting sort :class:`sal.incidence.SparseIncidence` does,
    ...
    def from_arcs(
        ...
        :func:`sal.search.alpha_expansion.expand` builds one
    ...
    def as_arrays(self) -> PairedArcs:
        ...
        layout :mod:`sal.search.maxflow.rust` crosses the
...
class GroundState:
    ...
    :func:`sal.search.maxflow.rust.ising_ground_state` are an
    ...
    energy : float
        Its energy under :func:`~sal.sim.potts.energy`, which
