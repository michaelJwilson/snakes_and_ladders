...
:func:`sal.validation.gymnasium.build` makes from the spec:
...
The adapter, formerly ``sal.learn.gym.GymnasiumEnvironment``,
...
the episode, which is what lets :mod:`sal.learn.exact`
...
counted in decisions as :func:`~sal.learn.rollout.rollout` counts
