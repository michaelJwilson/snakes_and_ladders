"""Regression tests for :mod:`sal.sim.potts`.
...
from sal.sim.potts import PottsLatticeParams, simulate_potts
...
def test_the_open_chain_path_reproduces_the_transfer_matrix_log_z() -> None:
    ...
    # same distribution described by sal.opt.potts's transfer matrix and
