...
SLIMMING_BASELINE = {
    ...
    # that rises states why here or it is a duplicate. Issue #779's three
    # deprecation shims are three modules while they stand, so the first row
    # reads 152 until the release after 0.3.0 removes them.
    "flat modules": 152,
