...
SLIMMING_BASELINE = {
    ...
    # `search.annealed` added both, a module and fourteen names. Issue #779's
    # three deprecation shims are three modules while they stand, so the first
    # row reads 153 until the release after 0.3.0 removes them.
    "flat modules": 153,
