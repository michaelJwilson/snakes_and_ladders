...
| --- | --- | --- | --- |
| Phylogenetic tree, Jukes–Cantor | `tree_search`, `tree_scale` | `sec:phylo` | `sim.jc`, `sim.simulate`, `likelihood.pruning`, `likelihood.pruning.rust`, `likelihood.hadamard`, `search.neighbor_joining`, `learn.tree`, `sandbox.tropical` |
...
| Count-pair coupled spatio-sequential model | `spatio_sequential_counts` | `sec:coupled` | `sim.count_pairs`, `sim.count_pairs.rust`, `likelihood.spatio_sequential.rust` |
