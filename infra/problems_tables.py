...
ALGORITHMS: dict[str, str] = {
    ...
    "sim.potts_chain.simulate_chains": "simulation",
    ...
    "sim.potts.tiling_field": "simulation",
    "sim.potts.tile_partition": "simulation",
    ...
    "sim.rust.count_pairs.simulate_count_pairs": "simulation",
    ...
    "likelihood.polar.decode_sc": "message passing",
    "likelihood.polar.decode_scl": "message passing",
    ...
    "likelihood.torch.pruning.log_likelihood": "exact evaluation",
    "likelihood.rust.pruning.log_likelihood": "exact evaluation",
    ...
    "likelihood.rust.spatio_sequential.class_posteriors": "exact evaluation",
    "likelihood.rust.spatio_sequential.external_field": "exact evaluation",
    ...
    "sim.topology.Model": "hill climbing",
    "search.infer.parsimony_search": "hill climbing",
    "sim.topology.nni_neighbours": "hill climbing",
    "sim.topology.spr_neighbours": "hill climbing",
...
ORACLES: dict[str, str] = {
    ...
    "sim.topology.enumerate_topologies": "enumeration or brute force",
    ...
    "sandbox.polar_reference.decode_sc_reference": "independent algorithm",
