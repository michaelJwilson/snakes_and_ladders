...
LADDER: tuple[Rung, ...] = (
    ...
    Rung(
        "tree",
        "pruning, Rust",
        "likelihood.rust.pruning.log_likelihood",
        "pruning, NumPy",
    ...
    Rung(
        "tree",
        "pruning, Torch",
        "likelihood.torch.pruning.log_likelihood",
        "pruning, NumPy",
        T + "likelihood/test_pruning_common.py"
    ...
    Rung(
        "hmm",
        "tree schedule, Rust",
        "likelihood.rust.message_passing.tree_messages",
        "forward via sum-product",
    ...
    Rung(
        "hmm",
        "ragged HMM",
        "likelihood.rust.ragged.posteriors",
        "forward / forward-backward",
    ...
    Rung(
        "hmm",
        "coupled, Rust",
        "likelihood.rust.spatio_sequential.class_posteriors",
        "coupled E and M steps",
    ...
    Rung(
        "codes",
        "BCJR, Rust",
        "likelihood.rust.convolutional.bcjr",
        "BCJR",
